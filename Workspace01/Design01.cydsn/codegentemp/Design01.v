...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("9ecf0d35-b04b-4575-a313-bed04cd0d6de/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_v3_10_4 (
	...
	cy_clock_v1_0
		#(.id("a3831c92-6046-45b1-bd54-d2469c57809b/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__PSala_net;
	wire [0:0] tmpFB_0__PSala_net;
	wire [0:0] tmpIO_0__PSala_net;
	wire [0:0] tmpINTERRUPT_0__PSala_net;
	electrical [0:0] tmpSIOVREF__PSala_net;
	...
	cy_psoc3_pins_v1_10
		...
		PSala
		 (.oe(tmpOE__PSala_net),
		  .y({Net_447}),
		  .fb({tmpFB_0__PSala_net[0:0]}),
		  .io({tmpIO_0__PSala_net[0:0]}),
		  .siovref(tmpSIOVREF__PSala_net),
		  .interrupt({tmpINTERRUPT_0__PSala_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PSala_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PHabitacion_net;
	wire [0:0] tmpFB_0__PHabitacion_net;
	wire [0:0] tmpIO_0__PHabitacion_net;
	wire [0:0] tmpINTERRUPT_0__PHabitacion_net;
	electrical [0:0] tmpSIOVREF__PHabitacion_net;

	cy_psoc3_pins_v1_10
		#(.id("c4aad95c-5f66-45c2-9355-1bd36f2a11ef"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PHabitacion
		 (.oe(tmpOE__PHabitacion_net),
		  .y({Net_386}),
		  .fb({tmpFB_0__PHabitacion_net[0:0]}),
		  .io({tmpIO_0__PHabitacion_net[0:0]}),
		  .siovref(tmpSIOVREF__PHabitacion_net),
		  .interrupt({tmpINTERRUPT_0__PHabitacion_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PHabitacion_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("b2de69ef-fe13-4c4b-8454-ff1ad06a11e1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PINB_net;
	wire [0:0] tmpFB_0__PINB_net;
	wire [0:0] tmpIO_0__PINB_net;
	wire [0:0] tmpINTERRUPT_0__PINB_net;
	electrical [0:0] tmpSIOVREF__PINB_net;

	cy_psoc3_pins_v1_10
		#(.id("278d1f3a-7608-4ef5-833d-d6929b0a700e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PINB
		 (.oe(tmpOE__PINB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PINB_net[0:0]}),
		  .io({tmpIO_0__PINB_net[0:0]}),
		  .siovref(tmpSIOVREF__PINB_net),
		  .interrupt({tmpINTERRUPT_0__PINB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PINB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PINC_net;
	wire [0:0] tmpFB_0__PINC_net;
	wire [0:0] tmpIO_0__PINC_net;
	wire [0:0] tmpINTERRUPT_0__PINC_net;
	electrical [0:0] tmpSIOVREF__PINC_net;

	cy_psoc3_pins_v1_10
		#(.id("2740f4ae-b3a8-427a-b55d-0614e1735220"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PINC
		 (.oe(tmpOE__PINC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PINC_net[0:0]}),
		  .io({tmpIO_0__PINC_net[0:0]}),
		  .siovref(tmpSIOVREF__PINC_net),
		  .interrupt({tmpINTERRUPT_0__PINC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PINC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIND_net;
	wire [0:0] tmpFB_0__PIND_net;
	wire [0:0] tmpIO_0__PIND_net;
	wire [0:0] tmpINTERRUPT_0__PIND_net;
	electrical [0:0] tmpSIOVREF__PIND_net;

	cy_psoc3_pins_v1_10
		#(.id("b11fa636-b2bd-4277-978a-32da9322a23e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PIND
		 (.oe(tmpOE__PIND_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIND_net[0:0]}),
		  .io({tmpIO_0__PIND_net[0:0]}),
		  .siovref(tmpSIOVREF__PIND_net),
		  .interrupt({tmpINTERRUPT_0__PIND_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIND_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PTEMP_net;
	wire [0:0] tmpFB_0__PTEMP_net;
	wire [0:0] tmpIO_0__PTEMP_net;
	wire [0:0] tmpINTERRUPT_0__PTEMP_net;
	electrical [0:0] tmpSIOVREF__PTEMP_net;
	...
	cy_psoc3_pins_v1_10
		...
		PTEMP
		 (.oe(tmpOE__PTEMP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PTEMP_net[0:0]}),
		  .analog({Net_44}),
		  .io({tmpIO_0__PTEMP_net[0:0]}),
		  .siovref(tmpSIOVREF__PTEMP_net),
		  .interrupt({tmpINTERRUPT_0__PTEMP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PTEMP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__PINMOV_net;
	wire [0:0] tmpFB_0__PINMOV_net;
	wire [0:0] tmpIO_0__PINMOV_net;
	electrical [0:0] tmpSIOVREF__PINMOV_net;

	cy_psoc3_pins_v1_10
		#(.id("906e984c-6275-40c3-8e0c-1b9fb2e56630"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PINMOV
		 (.oe(tmpOE__PINMOV_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PINMOV_net[0:0]}),
		  .io({tmpIO_0__PINMOV_net[0:0]}),
		  .siovref(tmpSIOVREF__PINMOV_net),
		  .interrupt({Net_173}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PINMOV_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [5:0] tmpOE__Pin_A_net;
	wire [5:0] tmpFB_5__Pin_A_net;
	wire [5:0] tmpIO_5__Pin_A_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .intr_mode(12'b01_01_01_01_01_01),
		  .invert_in_clock(0),
		  .invert_in_clock_en(0),
		  .invert_in_reset(0),
		  .invert_out_clock(0),
		...
		Pin_A
		 (.oe(tmpOE__Pin_A_net),
		  .y({6'b0}),
		  .fb({tmpFB_5__Pin_A_net[5:0]}),
		  .io({tmpIO_5__Pin_A_net[5:0]}),
	...
	assign tmpOE__Pin_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{6'b111111} : {6'b111111};
